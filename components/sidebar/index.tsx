...
const dashboardLinks = [
	...
	},
	{
		...
		Icon: InsightsIcon,
		shortcutText: shortcuts.menu.insights.shortcut,
	},
];
...
export default function Sidebar() {
	...
	useHotkeys(
		...
		(_, handler) => {
			...
			if (keys === shortcuts.menu.insights.shortcut) router.push('/dashboard/insights');
		},
		options
	);
				...
				<div className="z-[10] mb-[10px] flex h-full w-[100%] flex-col justify-between">
					<div className="flex h-full flex-col items-center justify-between">
						<div className="flex flex-col items-center">
							...
							>
								<Image className="block" src={SvgWhiteLogo} width={30} height={30} alt="Expense Mate" />
							</Link>
