...
const features = [
	{
		...
		description: 'Use your email and password to securely log in to the application.',
	...
	},
	{
		...
		description: 'Track your investment holdings and monitor how much you are investing over time.',
		Icon: () => (
			<svg
				className="ml-[-6px] mr-2 mt-[1px]"
				xmlns="http://www.w3.org/2000/svg"
		...
		screenshotUrl: '/demo/investments.jpg',
		demoUrl: '/demo/investments.mp4',
	},
